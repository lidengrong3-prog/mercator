...
supabase secrets set COZE_API_TOKEN=... COZE_BOT_ID=... DOUBAO_API_KEY=... DOUBAO_MODEL=... OPENAI_API_KEY=... OPENAI_MODEL=...
...
OpenAI and Codex use the Responses API; Coze uses `/open_api/v3/chat`.
