...
function jayBuildSettingsPage(){
  ...
  section.innerHTML='<div class="st-wrap">'
    ...
    +'<section class="st-tab" id="st-tab-alerts"><h2 style="margin:0 0 4px;font-size:20px">预警订阅</h2><p class="st-section-desc">订阅类型和当前市场范围随账号跨设备同步</p><div class="st-section"><h3 class="st-section-title">关注事件</h3><div class="st-alert-checks">'
    +'<label class="st-alert-check"><input type="checkbox" data-sub="product" checked> 商品价格、销量或评分异动</label><label class="st-alert-check"><input type="checkbox" data-sub="shop" checked> 店铺经营指标异常</label><label class="st-alert-check"><input type="checkbox" data-sub="content" checked> 新品与热门内容</label><label class="st-alert-check"><input type="checkbox" data-sub="policy" checked> 政策与合规风险</label><label class="st-alert-check"><input type="checkbox" data-sub="competition"> 类目竞争加剧</label><label class="st-alert-check"><input type="checkbox" data-sub="fx"> 汇率大幅波动</label></div><button type="button" class="st-btn st-btn-primary st-btn-sm" data-action="stSaveSubPref()" style="margin-top:12px">保存订阅</button></div>'
    ...
    +'<div class="st-section"><h3 class="st-section-title">显示单位</h3><div class="st-form-row"><div class="st-form-group"><label>货币</label><div style="display:flex;gap:8px"><button type="button" id="st-currency-cny" class="st-btn st-btn-sm st-btn-primary" data-action="stCurrency(\'cny\')">人民币</button><button type="button" id="st-currency-usd" class="st-btn st-btn-sm st-btn-outline" data-action="stCurrency(\'usd\')">美元</button></div></div><div class="st-form-group"><label>数值单位</label><div style="display:flex;gap:8px"><button type="button" id="st-unit-wan" class="st-btn st-btn-sm st-btn-primary" data-action="stUnit(\'wan\')">万</button><button type="button" id="st-unit-m" class="st-btn st-btn-sm st-btn-outline" data-action="stUnit(\'m\')">百万</button></div></div></div>'
    +'</div></section>'
    ...
    +'<div class="st-form-row" style="margin-top:16px"><div class="st-form-group"><label for="st-workspace-select">切换工作区</label><select class="st-select" id="st-workspace-select" data-change-action="stSwitchWorkspace(this.value)"><option value="">正在读取工作区…</option></select></div><div class="st-form-group"><label for="st-workspace-name">工作区名称</label><input class="st-input" id="st-workspace-name" maxlength="80" autocomplete="organization"></div></div>'
