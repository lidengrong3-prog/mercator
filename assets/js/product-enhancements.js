...
function jayBuildSettingsPage(){
  ...
  section.innerHTML='<div class="st-wrap">'
    ...
    +'<hr class="st-divider"><div class="st-section"><h3 class="st-section-title">数据权利</h3><p class="st-section-desc">你可以导出自己的账号数据，或申请删除账号及相关文件。删除前请先完成工作区所有权转移。</p><div class="st-inline-actions"><button type="button" class="st-btn st-btn-outline st-btn-sm" onclick="jayRequestDataExport()">导出我的数据</button><button type="button" class="st-btn st-btn-outline st-btn-sm" onclick="jayRequestAccountDeletion()">申请删除账号</button><span class="st-muted-inline" id="st-data-request-status"></span></div></div>'
    ...
    +'<div class="st-form-row" style="margin-top:16px"><div class="st-form-group"><label for="st-workspace-select">切换工作区</label><select class="st-select" id="st-workspace-select" onchange="stSwitchWorkspace(this.value)"><option value="">正在读取工作区…</option></select></div><div class="st-form-group"><label for="st-workspace-name">工作区名称</label><input class="st-input" id="st-workspace-name" maxlength="80" autocomplete="organization"></div></div>'
  +'<div class="st-form-row"><div class="st-form-group"><label>席位使用</label><input class="st-input" id="st-workspace-member-count" readonly value="读取中"></div><div class="st-form-group"><label>当前工作区权益</label><input class="st-input" id="st-workspace-billing-meta" readonly value="读取中"></div></div>'
    +'<div class="st-inline-actions"><button type="button" class="st-btn st-btn-primary st-btn-sm" id="st-workspace-save" onclick="stSaveWorkspaceName()">保存工作区</button><button type="button" class="st-btn st-btn-outline st-btn-sm" onclick="jayRequestWorkspaceDeletion()">申请删除工作区</button><span class="st-muted-inline" id="st-workspace-meta">读取工作区信息…</span></div></div>'
